...
func (x *UpdateInfoRequest) GetGender() int64 {
	if x != nil {
		return x.Gender
	}
	return 0
...
func (x *UpdateInfoRequest) GetMobile() string {
	if x != nil {
		return x.Mobile
	}
	return ""
...
var file_user_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x49, 0x64, 0x22, 0x82, 0x01, 0x0a, 0x10, 0x55, 0x73,
	...
	0x77, 0x6f, 0x72, 0x64, 0x32, 0xf8, 0x01, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
	...
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x17,
...
var file_user_proto_depIdxs = []int32{
	...
	6, // 3: user.UserService.updateUserinfo:input_type -> user.UpdateInfoRequest
	1, // 4: user.UserService.Login:output_type -> user.LoginResponse
	3, // 5: user.UserService.Register:output_type -> user.RegisterResponse
	5, // 6: user.UserService.UserInfo:output_type -> user.UserInfoResponse
	5, // 7: user.UserService.updateUserinfo:output_type -> user.UserInfoResponse
